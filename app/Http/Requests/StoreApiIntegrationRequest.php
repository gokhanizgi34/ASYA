...
class StoreApiIntegrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'username' => ['nullable', 'string', 'max:255', Rule::requiredIf($this->input('auth_type') === IntegrationAuthType::Basic->value)],
            ...
            'credential' => [$credentialRequired ? 'required' : 'nullable', 'string', 'max:4000'],
    ...
    public function messages(): array
    {
        return [
            ...
            'credential.max' => 'API anahtarı çok uzun.',
