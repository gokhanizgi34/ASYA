...
<article class="rounded-2xl border border-cyan-400/20 bg-cyan-400/[.04] p-6">
    ...
    <div class="mt-5 text-base text-slate-200 [&_h2]:font-black [&_h2]:text-white [&_h3]:font-bold [&_h3]:text-slate-100 [&_h4]:font-bold [&_h4]:text-slate-200">{!! $formattedBody !!}</div>
