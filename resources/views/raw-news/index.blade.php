                        ...
                        <tbody class="divide-y divide-white/10">
                            @forelse ($items as $item)
                                <tr class="align-top">
                                    ...
                                    <td class="px-5 py-4 text-right"><div class="flex justify-end gap-2"><a href="{{ route('raw-news.show', $item) }}" class="rounded-lg border border-white/10 px-3 py-2 text-sm hover:bg-white/5">İncele</a>@can('update',$item)<a href="{{ route('raw-news.edit',$item) }}" class="rounded-lg border border-cyan-400/20 px-3 py-2 text-sm text-cyan-300">Düzenle</a>@endcan</div></td>
                                </tr>
                            @empty
